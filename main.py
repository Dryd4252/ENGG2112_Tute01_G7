...
def main(save_files):
    ...
    # xgb_model.y_pred = xgb_model.make_prediction(xgb_model.X_test)
    ...
    xgb_model_2_params = [subproblem_b_targets]

    print("Training second model")
    xgb_model_2 = xgb(property_symbol_data, seed=seed)
    xgb_model_2.process_data(["critical_temp"])
    print(xgb_model_2.X_train.columns)
    xgb_model_2.train_model()
    xgb_model_2.test_prediction()
    xgb_model_2.classify_model_performance()
    plot_element_importance(xgb_model_2, symbol_data)
